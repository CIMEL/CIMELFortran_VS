...
c	FDATA='1267_20160503_2016061704071617'
	FDATA='SP81000112_1046201810'
C	TO CREATE INPUT FILE TITLE FOR AERONET INVERSION
c	存放参数文件以及数据文件主目录
     	FIPT='C:\Users\baker\CARSNET\AERONET_INVERSION\ins_para\'
c	存储AERONET反演算法所需输入输入文件的目录
cz      FOUT='g:\AERONET_INVERSION\input\'//trim(STNS_FN)//'\'//trim(STNS_ID
cz     &)//'\'
	FOUT='C:\Users\baker\CARSNET\AERONET_INVERSION\Main\Main\input\'
     &//trim(STNS_FN)//'\' 
	FBRDF='C:\Users\baker\CARSNET\AERONET_INVERSION\modis_brdf\' 
	FDAT='C:\Users\baker\CARSNET\CIMEL_NETWORK\'
...
c	to read modis brdf parameter
	OPEN(125,
     &FILE=TRIM(FBRDF)//'MCD43C3006_'//TRIM(STNS_FN)//
